...
variable "yc_token" {}
variable "yc_folder_id" { default = "b1gakt6tsl68n11f3qg2" }
variable "vpc_network_id" { default = "enphrlau1racmkvhrfsm" }
...
resource "yandex_dns_recordset" "root_a" {
  ...
  type    = "A"
  ttl     = 300
  data    = [yandex_lb_network_load_balancer.nlb.listener[0].external_address_spec[0].address]
}
...
output "dns_zone_name_servers" {
  value = yandex_dns_zone.primary.name_servers
}
